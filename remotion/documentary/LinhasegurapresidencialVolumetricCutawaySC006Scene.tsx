...
export interface LinhasegurapresidencialVolumetricCutawaySC006SceneProps {
  accentColor?: string;
...
/**
 * 🔬 LinhasegurapresidencialVolumetricCutawaySC006Scene: Reconstrução Isométrica 3D Documental
 * Desenvolvido autonomamente pelo Squad de Motion Graphics.
 * Arquétipo: VOLUMETRIC_CUTAWAY
 * Mecanismo: O Palácio do Planalto foi projetado nos anos cinquenta com monumentais fachadas de vidro, criando um problema moderno para a segurança nacional.
 */
export const LinhasegurapresidencialVolumetricCutawaySC006Scene: React.FC<LinhasegurapresidencialVolumetricCutawaySC006SceneProps> = ({
  accentColor = '#FF5500',
  telemetryColor = '#00F0FF',
  headerTag = 'RAIO-X 3D // VOLUMETRIC CUTAWAY',
  title = 'CORTE VOLUMÉTRICO MICROMÉTRICO // SC_006',
