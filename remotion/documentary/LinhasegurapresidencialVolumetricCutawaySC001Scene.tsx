...
export interface LinhasegurapresidencialVolumetricCutawaySC001SceneProps {
  accentColor?: string;
...
/**
 * 🔬 LinhasegurapresidencialVolumetricCutawaySC001Scene: Reconstrução Isométrica 3D Documental
 * Desenvolvido autonomamente pelo Squad de Motion Graphics.
 * Arquétipo: VOLUMETRIC_CUTAWAY
 * Mecanismo: No terceiro andar do Palácio do Planalto, a porta do gabinete presidencial se fecha e um telefone cinza sem visor comercial é retirado do gancho.
 */
export const LinhasegurapresidencialVolumetricCutawaySC001Scene: React.FC<LinhasegurapresidencialVolumetricCutawaySC001SceneProps> = ({
  accentColor = '#FF5500',
  telemetryColor = '#00F0FF',
  headerTag = 'RAIO-X 3D // VOLUMETRIC CUTAWAY',
  title = 'CORTE VOLUMÉTRICO MICROMÉTRICO // SC_001',
