...
export interface EncomendachinacuritibaVolumetricCutawaySC017SceneProps {
  accentColor?: string;
...
/**
 * 🔬 EncomendachinacuritibaVolumetricCutawaySC017Scene: Reconstrução Isométrica 3D Documental
 * Desenvolvido autonomamente pelo Squad de Motion Graphics.
 * Arquétipo: VOLUMETRIC_CUTAWAY
 * Mecanismo: A máquina não gera uma fotografia comum. Ela emite dois feixes de raios-X em frequências energéticas distintas para medir a atenuação atômica de cada componente dentro da embalagem.
 */
export const EncomendachinacuritibaVolumetricCutawaySC017Scene: React.FC<EncomendachinacuritibaVolumetricCutawaySC017SceneProps> = ({
  accentColor = '#FF5500',
  telemetryColor = '#00F0FF',
  headerTag = 'RAIO-X 3D // VOLUMETRIC CUTAWAY',
  title = 'CORTE VOLUMÉTRICO MICROMÉTRICO // SC_017',
