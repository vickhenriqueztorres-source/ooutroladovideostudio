...
export interface LinhasegurapresidencialFlowDynamicsSC014SceneProps {
  accentColor?: string;
...
/**
 * 🔬 LinhasegurapresidencialFlowDynamicsSC014Scene: Reconstrução Isométrica 3D Documental
 * Desenvolvido autonomamente pelo Squad de Motion Graphics.
 * Arquétipo: FLOW_DYNAMICS
 ...
 */
export const LinhasegurapresidencialFlowDynamicsSC014Scene: React.FC<LinhasegurapresidencialFlowDynamicsSC014SceneProps> = ({
  accentColor = '#FF5500',
  telemetryColor = '#00F0FF',
  headerTag = 'RAIO-X 3D // FLOW DYNAMICS',
  title = 'DINÂMICA DE FLUXO PRESSURIZADO // SC_014',
  ...
  return (
    ...
    >
      ...
      <IsometricViewport
        rotateX={58 + cameraDrift}
        rotateZ={-38 + cameraDrift * 0.5}
        scale={1 * entrance}
        perspective={1400}
      >
