...
export interface LinhasegurapresidencialVolumetricCutawaySC004SceneProps {
  accentColor?: string;
...
/**
 * 🔬 LinhasegurapresidencialVolumetricCutawaySC004Scene: Reconstrução Isométrica 3D Documental
 ...
 */
export const LinhasegurapresidencialVolumetricCutawaySC004Scene: React.FC<LinhasegurapresidencialVolumetricCutawaySC004SceneProps> = ({
  accentColor = '#FF5500',
  telemetryColor = '#00F0FF',
  headerTag = 'RAIO-X 3D // VOLUMETRIC CUTAWAY',
  title = 'CORTE VOLUMÉTRICO MICROMÉTRICO // SC_004',
