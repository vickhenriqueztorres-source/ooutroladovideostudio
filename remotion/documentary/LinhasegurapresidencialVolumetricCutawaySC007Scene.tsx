...
export interface LinhasegurapresidencialVolumetricCutawaySC007SceneProps {
  accentColor?: string;
...
/**
 * 🔬 LinhasegurapresidencialVolumetricCutawaySC007Scene: Reconstrução Isométrica 3D Documental
 * Desenvolvido autonomamente pelo Squad de Motion Graphics.
 * Arquétipo: VOLUMETRIC_CUTAWAY
 * Mecanismo: Microfones a laser apontados a centenas de metros de distância conseguem ler as microscópicas vibrações causadas pelo som nas vidraças.
 */
export const LinhasegurapresidencialVolumetricCutawaySC007Scene: React.FC<LinhasegurapresidencialVolumetricCutawaySC007SceneProps> = ({
  accentColor = '#FF5500',
  telemetryColor = '#00F0FF',
  headerTag = 'RAIO-X 3D // VOLUMETRIC CUTAWAY',
  title = 'CORTE VOLUMÉTRICO MICROMÉTRICO // SC_007',
