...
const flow: Partial<Record<ProjectState, readonly ProjectState[]>> = {
  ...
  EDIT_BLUEPRINT_APPROVED: ["PROMPT_PACK_APPROVED"], PROMPT_PACK_APPROVED: ["REFERENCES_APPROVED"],
  REFERENCES_APPROVED: ["START_FRAMES_APPROVED"], START_FRAMES_APPROVED: ["VIDEO_BATCH_RUNNING"],
  ...
  HUMAN_REQUIRED: ["CREATED", "TOPIC_APPROVED", "SCRIPT_APPROVED", "EDIT_BLUEPRINT_APPROVED", "PROMPT_PACK_APPROVED", "REFERENCES_APPROVED", "START_FRAMES_APPROVED", "VIDEO_BATCH_RUNNING", "VIDEO_BATCH_APPROVED", "AUDIO_APPROVED", "ASSEMBLY_READY", "MASTER_APPROVED", "PACKAGING_READY"],
