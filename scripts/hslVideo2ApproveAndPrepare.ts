...
function main(): void {
  ...
  const manifestPath = path.join(outputRoot, 'firefly', 'video-2-generation-preparation.json');
  writeJson(manifestPath, {
    schema: 'hsl.video-2.generation-preparation.v1', schema_version: '1.0.0', production_id: productionId,
